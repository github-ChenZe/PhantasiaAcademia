...
\begin{multicols*}{3}[\centerline{\titlefont Algebra in Quantum Mechanics}]
\raggedcolumns%
\newheader{Commutators}
\begin{cheatresume}
\begin{flalign*}
    & \mathitem{Baker-Hausdorff} && e^{iG\lambda}Ae^{-iG\lambda} = A + i\lambda\brac{G,A} + \frac{\pare{i\lambda}^2}{2!}\brac{G,\brac{G,A}} + \cdots + \frac{\pare{i\lambda}^n}{n!}\underbrace{[G,[G,[G,\cdots[G}_{n\ \mathrm{times}},A]]]] + \cdots &&
\end{flalign*}
\end{cheatresume}
