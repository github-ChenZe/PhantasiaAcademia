...
$\displaystyle R = \abs{\frac{f'''\pare{\xi}}{3!}\pare{x-x_0}\pare{x-x_1}\pare{x-x_2}}$\\
$\displaystyle = \abs{\frac{3}{8}\xi^{-5/2}\cdot \rec{6}\pare{105-81}\pare{105-100}\pare{105-121}} = \boxed{2.03\times 10^{-3}.}$
\newprob{1.8}%
...
\begin{equation*}
    \boxed{p\pare{x} = \begin{cases}
        ...
        \displaystyle +\pare{x-1}^2\brac{1+\pare{x-2}\pare{3x - 8}} \\[.5em]
