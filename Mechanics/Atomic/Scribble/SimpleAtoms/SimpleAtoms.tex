...
\begin{cheatresume}
    \begin{flalign*}
        & \mathitem{Lyman} && n = 1 && \mathitem{s} && l = 0 && \mathitem{S(Sub II)} && n\mathrm{s}\mapsto 3\mathrm{p} \\
        & \mathitem{Balmer} && n = 2 && \mathitem{p} && l = 1 && \mathitem{P} && n\mathrm{p}\mapsto 3\mathrm{s} && \\
        & \+:c3l{$\mathitem{$H_\alpha$}\quad n=3\mapsto n=2$} && \mathitem{d} && l = 2 && \mathitem{D(Sub I)} && n\mathrm{s}\mapsto 3\mathrm{p} \\
        & \mathitem{Paschen} && n = 3 && \mathitem{f} && l = 3 && \mathitem{F(Bergmann)} && n\mathrm{f}\mapsto 3\mathrm{d} \\
        & \mathitem{D線} && 3p \mapsto 3s
    \end{flalign*}
\end{cheatresume}
...
\begin{cheatresume}
    \begin{flalign*}
        ...
        & && n\pare{\theta_1\sim\theta_2} = Nnt\pi \frac{D^2}{2}\pare{\cot^2 \frac{\theta_2}{4} - \cot^2 \frac{\theta_1}{2}} &&
    \end{flalign*}
\end{cheatresume}
\newheader{\bili{}{量子力学}}
\begin{cheatresume}
