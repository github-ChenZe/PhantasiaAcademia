...
\begin{remark}
	电池中的静电平衡验证了\rmref{静电平衡可能要求非零电场}.
\end{remark}
\begin{finale}
...
\end{figure}
\begin{ex}
	对于\fref{Kirchhoff方程组求解示例3}中的电桥, 欲求出其电阻, 接通一虚拟无内阻电源$U$, 仿照\eref{Wheatstone电桥用Kirchhoff方程求解}可得$I = U/\SI{32}{\ohm}$, 相当于$R=\SI{32}{\ohm}$.
\end{ex}
...
\begin{finale}
	...
	\end{theorem}
\end{finale}
有源二端网络的\emph{开路电压}谓两个引出端不与外界相接时的电压. \emph{除源网络}谓将网络内部所有电源摘除后的结果, 「摘除」的定义参考\rmref{电源的单独存在}.
\begin{finale}
...
\end{ex}
\begin{ex}
	将\eref{Wheatstone电桥用Kirchhoff方程求解}中的Wheatstone电桥变换为\fref{Wheatstone电桥变换为适用Thevenin定理的情形}中的电路, 有
