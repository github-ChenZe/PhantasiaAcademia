...
\begin{figure}
	...
	\begin{subfigure}{.45\textwidth}
		\centering
			\includegraphics{src/ex1CircuitWithBattery.pdf}
		\caption{}
		\label{fig:含电源电路示例1}
	\end{subfigure}
	\begin{subfigure}{.45\textwidth}
...
\end{figure}
\begin{ex}
	在\fref{含电源电路示例1}中, 设$\cE_1 = \SI{6}{V}$, $r_1 = \SI{1}{\ohm}$, $\cE_2 = \SI{4}{V}$, $r_2 = \SI{2}{\ohm}$, $R = \SI{2}{\ohm}$. 由\eqref{eq:全电路的Ohm定律}, 有
...
\end{remark}
\begin{ex}
	在\fref{纯电源电路示例1}中, 电流为$I = 4\cE/\pare{4r} = \cE/r$, 从而任意电源外任意两点皆有$U = 0$.
\end{ex}
\begin{figure}
	\centering
	\includegraphics{src/ex1CircuitMeasuringE.pdf}
	\caption{补偿法测量电动势}
	\label{fig:补偿法测量电动势}
\end{figure}
通过补偿法可以测量电动势. 如\fref{补偿法测量电动势}.
\begin{cenum}
...
\begin{figure}
	...
	\begin{subfigure}[b]{.45\textwidth}
		\centering
		\includegraphics{src/ex1Kirchhoff.pdf}
		\caption{}
		\label{fig:Kirchhoff方程组求解示例1}
	\end{subfigure}
	\begin{subfigure}[b]{.45\textwidth}
		\centering
		\includegraphics{src/ex2Kirchhoff.pdf}
		\caption{}
...
\end{figure}
\begin{ex}
	对于\fref{Kirchhoff方程组求解示例1}中的回路, 有
	\[ \begin{cases}
		I_1 = I_2 + I_3,\\
...
\begin{ex}
	...
	对于\fref{Kirchhoff方程组求解示例2}中的Wheatstone电桥, 欲求出$I_G$与$\cE$和诸$R$的关系,
	\[ \begin{cases}
		I_1 = I_3 + I_G,\\
		I_4 = I_G + I_2,\\
		I = I_1 + I_2,\\
...
\begin{figure}
	...
	\begin{subfigure}[b]{.45\textwidth}	
		\centering
		\includegraphics{src/ex3Kirchhoff.pdf}
		\caption{}
		\label{fig:Kirchhoff方程组求解示例3}
	\end{subfigure}	
	\begin{subfigure}[b]{.53\textwidth}
		\centering
		\includegraphics{src/WheatstoneBridge.pdf}
		\caption{}
...
\end{figure}
\begin{ex}
	对于\fref{Kirchhoff方程组求解示例3}中的电桥, 欲求出其电阻, 接通一虚拟无内阻电源$U$, 仿照\cref{ex:Wheatstone电桥用Kirchhoff方程求解}可得$I = U/\SI{32}{\ohm}$, 相当于$R=\SI{32}{\ohm}$.
\end{ex}
...
\end{ex}
\begin{ex}
	将\cref{ex:Wheatstone电桥用Kirchhoff方程求解}中的Wheatstone电桥变换为\fref{Wheatstone电桥变换为适用Thevenin定理的情形}中的电路, 有
