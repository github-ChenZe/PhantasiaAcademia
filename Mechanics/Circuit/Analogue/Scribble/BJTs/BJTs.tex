...
\begin{flalign*}
    ...
    & \mathitem{電圧増幅率} && A_v = \frac{-\beta R'\+_L_}{r\+_be_ + \pare{1+\beta} R\+_e_} && \\
...
\begin{tikzpicture}[scale=0.8]
    \begin{axis}[
        axis lines=left,xlabel=$v\+_CE_$,
        ylabel=$i\+_C_$,xmin=0,xmax=17,ymin=0,ymax=24,xtick={0,5,10,15},xticklabels={\mbox{},5,10,\mbox{}},ytick={0,10,20}, minor tick num=4,%
        xlabel style={
