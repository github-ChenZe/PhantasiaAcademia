...
%\definecolor{itemgray}{RGB}{143,159,172}
\definecolor{itemgray}{RGB}{114,134,144}
...
\begin{cheatresume}
    \begin{flalign*}
        ...
        & &&\eta = \psi\pare{x,y} \mathcomment{巧取} \\
        & \mathitem{标准形} && \frac{\partial^2 u}{\partial \eta^2} + \rec{A_{22}}\pare{B_1 u_\xi + B_2 u_\eta + Cu} = 0
    \end{flalign*}
\end{cheatresume}
\newheader{冲量原理}
\begin{cheatresume}
...
\begin{cheatresume}
    \begin{flalign*}
        ...
        & && \mathheadcomment{i.e.} \begin{cases}
            A_{IJ} = a_{ij}I_i J_j \\
            B_I = a_{ij}I_{ij} + b_i I_i
        \end{cases} &&
    \end{flalign*}
\end{cheatresume}
